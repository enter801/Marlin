...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION 17//Should be y min position + y probe offset as a minimum -> 0 + 70 (real offset from nozzle) = 70 + 10 (for margin) = 80 (update to use vars) -BM
